        ...
        <article >
            ...
            <div class="article-content bg-color">
                ...
                <div class="article-fx">
                    {{--<span style="margin-right:1em;background-color:--}}
{{--#f77825 !important;" class="img-circle" href="javascript:void(0)" onClick="zan()">点赞(150)</span>--}}
                    <span class="img-circle" href="javascript:void(0)" onClick="dashangToggle()">打赏</span>&nbsp;&nbsp;&nbsp;
                    <a class="fx-btn img-circle" href="javascript:;">分享</a>
                ...
                <div class="article_tag">
                    <ul >
                        ...
                        <li><a href="/category/{{ $data->category_id }}" target="_blank" title="归类：{{ $data->category_name }}">{{ $data->category_name }}</a></li>
                        @foreach($data->tag as $k => $v)
                            <li>
                                <a class="b-tag-name" target="_blank" title="标签：{{ $v->name }}" href="/tag/{{ $v->id }}">{{ $v->name }}</a>
                            </li>
                        @endforeach
                    </ul>
                </div>
...
<div class="shang_box">
    ...
    <div class="shang_payimg">
        <img src="/Template/xiao/Home/Public/images/icon/alipayimg.jpg" alt="扫码查看" title="扫一扫" />
    </div>
...
<script>
    $(function(){
        $(".pay_item").click(function(){
            ...
            $(".shang_payimg img").attr("src","/Template/xiao/Home/Public/images/icon/"+dataid+"img.jpg");
