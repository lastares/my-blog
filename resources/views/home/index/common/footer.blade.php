<footer>
    ...
    <div class="foot-nav">
        ...
        <div class="bottom-nav">
            ...
            <span><a href="http://www.songyaofeng.com/admin/index/index">后台</a>&nbsp;&nbsp; </span><span><a href="http://www.miitbeian.gov.cn/state/outPortal/loginPortal.action"> {{ $config['WEB_ICP_NUMBER'] }}</a>
        <!--CNZZ统计开始-->
