        ...
        <div class="b-box-textarea" >
            ...
            <ul class="b-emote-submit">
                <li class="b-emote">
                    ...
                    <input style="height:30px;width:20%;font-size:12px;margin-top:1px;" class="form-control b-email" type="text" name="email" @if(empty(session('user.email'))) placeholder="亲，邮箱请到会员中心认证" value="" @else placeholder="" value="{{ session('user.email') }}"  @endif disabled>
                    <div class="b-tuzki">
