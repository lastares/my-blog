                ...
                <div class="message_style" style="height:auto;padding:35px;" >
                    ...
                    <div class="row b-comment">
                        ...
                        <div class="col-xs-12 col-sm-12 col-md-12 col-lg-12 b-comment-title">
                            <ul class="row">
                                <li class="col-xs-6 col-sm-6 col-md-6 col-lg-6 new-comment">最新评论</li>
                                <li class="col-xs-6 col-sm-6 col-md-6 col-lg-6 text-right">总共<span class="new-comment"> {{ count($comment) }} </span>条评论
                                </li>
                            </ul>
                        </div>
