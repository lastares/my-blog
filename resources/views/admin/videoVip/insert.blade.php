...
@section('content')
        ...
        <ul class="breadcrumb" style="font-size: 16px;">
            ...
            <li class="active">添加视频会员</li>
        </ul>
        <div class="row">
            <div class="col-md-2 col-md-offset-9">
                <button type="button" class="btn btn-success" onclick="window.history.go(-1);">返回视频会员列表</button>
            </div>
        </div>
        <form class="form-horizontal">
            ...
            <div class="form-group">
                ...
                <div class="col-sm-6">
                    <input type="text" name="video_vip_name" class="form-control" id="video_vip_name" placeholder="请输入视频种类">
                </div>
            </div>
            <div class="form-group">
                <label for="video_vip_price" class="col-sm-2 control-label">视频会员价格</label>
                <div class="col-sm-6">
                    <input type="text" name="video_vip_price" class="form-control" id="video_vip_price" placeholder="请输入视频会员价格">
                </div>
            </div>
            <div class="form-group">
                <label for="video_vip_description" class="col-sm-2 control-label">视频会员描述</label>
                <div class="col-sm-6">
                    <textarea placeholder="请输入视频会员描述" name="video_vip_description" id="video_vip_description" cols="80" rows="10"></textarea>
                </div>
            </div>
            <div class="form-group">
                ...
                <div class="col-sm-6" style="margin-top: 10px;">
                    ...
                    <input type="hidden" name="video_vip_logo" id="banner_img" value=""/>
                </div>
            </div>
            <div class="form-group">
