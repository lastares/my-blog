// js动态加载表情
    function getTuzki(obj){
        ...
        if(tuzkiNumber){
            ...
            var str='';
            for (var i = 1; i < 41; i++) {
                str+='<img src="/home/plugins/emote/tuzki/'+i+'.gif" title="'+alt[i-1]+'" alt="'+titleName+'">';
            };
            tuzkiObj.html(str);
            tuzkiNumber=0;
        }else{
